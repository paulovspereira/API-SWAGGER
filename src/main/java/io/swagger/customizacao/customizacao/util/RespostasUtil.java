//Classe que vai tratar outra resposta da nossa api

package io.swagger.customizacao.customizacao.util;
...
//Classe ResponsasUtil devolva as mensagem de errros que pode ocasionar no retorno da api no controller
//Camada de negocio
@Component
